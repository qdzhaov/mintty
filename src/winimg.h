...
extern bool winimg_new(imglist * * ppimg, const char * id,
...
extern void win_emoji_show(int x, int y, const wchar * efn, void * * bufpoi, int * buflen, int elen, ushort lattr, bool italic);
