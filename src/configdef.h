...
#define BGF(f,t,a) {W(f),t,a,0}
  ...
  _CFGDEFD(string   ,dark_theme             ,("")            ,       IS(0),OPT_STR          ,OPF_THEME,9,0,7,"ThemeDark"                ,__("ThemeDark")                )
  ...
  _CFGDEFD(CBOOL    ,underl_manual          ,1               ,       IS(0),OPT_BOOL         ,OPF_CHK  ,3,5,0,"UnderlineManual"          ,__("UnderlineManual")          )
...
//_CFGDEFD(CBOOL    ,old_keyfuncs_keypad    ,0               ,       IS(0),OPT_BOOL         ,OPF_CHK  ,3,0,0,"OldKeyFunctionsKeypad"    ,__("OldKeyFunctionsKeypad")                  )
  ...
  _CFGDEFD(wstring  ,key_commands           ,W("")           ,       IS(0),OPT_WSTR         ,OPF_HKEY ,1,0,4,"KeyFunctions"             ,__("KeyFunctions")                           )
  _CFGDEFD(wstring  ,key_remap              ,W("")           ,       IS(0),OPT_WSTR         ,OPF_HKEY ,1,0,4,"Keyremap"                 ,__("Keyremap")                           )
  ...
  _CFGDEFC(0        ,=======                ,0               ,       IS(0),OPT_CMT          ,OPF_COL  ,9,2,0,""  ,0)
  _CFGDEFD(string   ,mouse_pointer          ,"ibeam"         ,       IS(0),OPT_STR          ,OPF_CURS ,3,5,4,"MousePointer"             ,__("MousePointer")                       )
  _CFGDEFD(string   ,appmouse_pointer       ,"arrow"         ,       IS(0),OPT_STR          ,OPF_CURS ,3,5,4,"AppMousePointer"          ,__("AppMousePointer")                    )
  _CFGDEFD(string   ,pixmouse_pointer       ,"cross"         ,       IS(0),OPT_STR          ,OPF_CURS ,3,5,4,"PixMousePointer"          ,__("PixMousePointer")                    )
  ...
  _CFGDEFD(wstring  ,drop_commands          ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"DropCommands"             ,__("DropCommands")             )
  _CFGDEFD(wstring  ,exit_commands          ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"ExitCommands"             ,__("ExitCommands")             )
  _CFGDEFD(wstring  ,user_commands          ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"UserCommands"             ,__("UserCommands")             )
  _CFGDEFD(wstring  ,ctx_user_commands      ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"CtxMenuFunctions"         ,__("CtxMenuFunctions")         )
  _CFGDEFD(wstring  ,sys_user_commands      ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"SysMenuFunctions"         ,__("SysMenuFunctions")         )
  _CFGDEFD(wstring  ,user_commands_path     ,W("/bin:%s")    ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"UserCommandsPath"         ,__("UserCommandsPath")         )
  _CFGDEFD(wstring  ,session_commands       ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"SessionCommands"          ,__("SessionCommands")          )
  _CFGDEFD(wstring  ,task_commands          ,W("")           ,       IS(0),OPT_WSTR         ,OPF_WSTR ,1,0,7,"TaskCommands"             ,__("TaskCommands")             )
  ...
  _CFGDEFD(int      ,max_image_size         ,4444444         ,IV( 0,    0),OPT_INT          ,OPF_INT  ,1,0,5,"MaxImageSize"             ,__("MaxImageSize")             )
